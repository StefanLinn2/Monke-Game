...
let player_char = [
    ...
    ,
    {
        controller: updateControlsForRobot,
        x: 0,
        y: 0,
        width: 32,
        height: 56,
...
//limit is 10,000 monkeys
for (let i = 0; i < 10; i++) {
    player_char.push(
        {
            controller: buildUpdateFunction(i * 10),
            x: 0,
            y: 0,
            width: 32,
            height: 56,
...
//replace you win with which monkey won, make sure 2nd place doesn't overwrite